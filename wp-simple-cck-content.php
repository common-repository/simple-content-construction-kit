 ...
 function scck_products_type_list ($error = array()) {
  ...
  <h2>Manage Content Type</h2>
   <table width="100%" cellspacing="0" cellpadding="2">
    <tr>
    <td><h3>Help us to promote this plugin, Give us five star rating <a href="https://wordpress.org/support/plugin/simple-content-construction-kit/reviews/"  target="new">click here</a></h3></td>
    <td><h3>How do i use it.<a href="http://scriptut.com/wordpress/how-to-i-use-custom-post-type-plugin-in-wordpress/"  target="new">click here to read</a></h3></td>
    </tr>
  </table>
  <?php
